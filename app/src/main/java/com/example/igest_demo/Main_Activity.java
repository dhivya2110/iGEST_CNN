package com.example.igest_demo;
...
public class Main_Activity extends ActionBarActivity {
    ...
    public static boolean OnUtter = false;
                ...
                new TextToSpeech.OnInitListener() {
                    ...
                    public void onInit(int status) {
                        if (status == TextToSpeech.SUCCESS) {
                            textToTalk.setLanguage(Locale.US);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MESSAGE_CAl:
                    ...
                    String yaw_bias=Double.toString(yaw_0);
                    String pitch_bias=Double.toString(pitch_0);
                    String roll_bias=Double.toString(roll_0);
                    display.setText("Y "+ yaw_bias + " " + "P " + pitch_bias + " " + "R" + roll_bias + " ");
                    Log.v("YPR","Y "+ yaw_bias + " " + "P " + pitch_bias + " " + "R" + roll_bias + " ");
                    break;
